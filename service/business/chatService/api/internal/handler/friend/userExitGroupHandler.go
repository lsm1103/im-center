...
func UserExitGroupHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UserExitGroupReq
		...
		l := friend.NewUserExitGroupLogic(r.Context(), svcCtx)
		err := l.UserExitGroup(req)
		/*
			if err != nil {
				httpx.Error(w, err)
			} else {
